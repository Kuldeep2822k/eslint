...
function messageTemplate(it) {
	...
	const validRuleUrl = ruleUrl && !/^\s*(?:javascript|vbscript|data):/iu.test(ruleUrl) ? ruleUrl : "";
...
<tr style="display: none;" class="f-${parentIndex}">
    ...
    <td>
        <a href="${validRuleUrl ? encodeHTML(validRuleUrl) : ""}" target="_blank" rel="noopener noreferrer">${ruleId ? encodeHTML(ruleId) : ""}</a>
    </td>
</tr>
`.trimStart();
}
